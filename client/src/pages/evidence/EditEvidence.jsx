    ...
    <div className="max-w-3xl mx-auto space-y-5">
      ...
      {saved && (
        <div className="flex items-center gap-2.5 bg-emerald-500/10 border border-emerald-500/30 rounded-xl px-5 py-3.5">
          ...
          <p className="text-emerald-700 text-sm font-medium">Evidence updated successfully! Redirecting...</p>
        </div>
      )}
      ...
      <div className="card">
        <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-200">
          ...
          <div>
            <h2 className="font-heading font-semibold text-xl text-navy-900">Edit Evidence</h2>
            <p className="text-slate-500 text-xs font-mono">{form.evidenceName}</p>
          </div>
        </div>
