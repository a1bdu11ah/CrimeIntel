      ...
      <div className="card p-0 overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-navy-800">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-heading font-semibold text-white">Evidence Records</h3>
          </div>
            ...
            <tbody>
              ...
              {!loading && !error && filtered.map((evidence) => (
                <tr key={evidence._id} className="table-row">
                  <td className="table-cell font-medium text-white">{evidence.evidenceName}</td>
                  <td className="table-cell">{evidence.evidenceType}</td>
                  <td className="table-cell font-mono text-blue-400 text-xs">{evidence.caseNumber}</td>
