    ...
    <div className="max-w-3xl mx-auto space-y-5">
      ...
      {saved && (
        <div className="flex items-center gap-2.5 bg-emerald-500/10 border border-emerald-500/30 rounded-xl px-5 py-3.5">
          ...
          <p className="text-emerald-400 text-sm font-medium">Case updated successfully! Redirecting...</p>
        </div>
      )}
      ...
      <div className="card">
        <div className="flex items-center gap-3 mb-6 pb-4 border-b border-navy-800">
          ...
          <div>
            <h2 className="font-heading font-semibold text-xl text-white">Edit Case</h2>
            <p className="text-steel-400 text-xs font-mono">{form.caseNumber}</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                className="form-input bg-navy-950 opacity-70 cursor-not-allowed"
