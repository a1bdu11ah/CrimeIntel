    ...
    <div className="max-w-3xl mx-auto space-y-5">
      ...
      {saved && (
        <div className="flex items-center gap-2.5 bg-emerald-500/10 border border-emerald-500/30 rounded-xl px-5 py-3.5">
          ...
          <p className="text-emerald-400 text-sm font-medium">FIR updated successfully! Redirecting...</p>
        </div>
      )}
      ...
      <div className="card">
        <div className="flex items-center gap-3 mb-6 pb-4 border-b border-navy-800">
          ...
          <div>
            <h2 className="font-heading font-semibold text-xl text-white">Edit FIR</h2>
            <p className="text-steel-400 text-xs font-mono">{form.firNumber}</p>
          </div>
        </div>
