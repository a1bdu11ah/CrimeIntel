      ...
      <div className="card p-0 overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-heading font-semibold text-navy-900">FIR Records</h3>
          </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              ...
              {!loading && error && (
                <tr>
                  <td colSpan={7} className="text-center py-12 text-red-700 text-sm">{error}</td>
                </tr>
              )}
              ...
              {!loading && !error && filtered.map((fir) => (
                <tr key={fir._id} className="table-row">
                  ...
                  <td className="table-cell text-navy-900 font-medium">{fir.complainantName}</td>
                  <td className="table-cell text-slate-500 text-xs">{fir.policeStation}</td>
                  <td className="table-cell">
